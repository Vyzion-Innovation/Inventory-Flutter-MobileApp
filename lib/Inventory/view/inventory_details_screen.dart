      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(height: 8),
            Text("Created At: ${DateTime.fromMillisecondsSinceEpoch(inventory.createdAt ?? 0)}", style: const TextStyle(fontSize: 16)),
            const SizedBox(height: 8),
            Text("Updated At: ${DateTime.fromMillisecondsSinceEpoch(inventory.updatedAt ?? 0)}", style: const TextStyle(fontSize: 16)),
          ],
        ),
      ),
    );
