...
class AppColors {
  ...
  static const Color colorBlack = Color(0xff1E1B18);
  static const Color searchBackColor = Color(0xffFFEBE4);
  static const Color selectSegment = Color(0xff1E1B18);
  ...
  static const Color warningColor = Color(0xfffbbc06);
  static const Color dangerColor = Color(0xffff3366);
  static const Color lightColor = Color(0xffe9ecef);
