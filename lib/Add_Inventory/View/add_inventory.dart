...
class InventoryFormScreen extends StatelessWidget {
  ...
  final InventoriesController inventorycontroller =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: controller.isSaving.value
          ? const Center(
                  ...
                  children: [
                                ...
                                onPressed: () async {
                                  DateTime? pickedDate = await showDatePicker(
                                    ...
                                    initialDate: DateTime
                                        .now(), // Current date as the default
                                    firstDate: DateTime(
                                        2000), // Earliest selectable date
                                    lastDate: DateTime(
                                        2100), // Latest selectable date
                                  );
                                  if (pickedDate != null) {
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: CustomButton(
                            title: controller.inventoryData == null
                                ? Strings.save
                                : 'Update',
                            color: AppColors.primaryColor,
                            onTap: () {
